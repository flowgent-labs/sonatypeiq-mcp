...
func MoveOrganizationHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "PUT", "/api/v2/organizations/{organizationId}/move/destination/{destinationId}", args, []string{"destinationId", "organizationId"}, contentType, "MoveOrganization")
}
