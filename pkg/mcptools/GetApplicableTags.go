...
func GetApplicableTagsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/api/v2/applicationCategories/organization/{organizationId}/applicable", args, []string{"organizationId"}, contentType, "GetApplicableTags")
}
