...
func GetLatestForStageHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/api/v2/spdx/{applicationId}/stages/{stageId}", args, []string{"applicationId", "stageId"}, contentType, "GetLatestForStage")
}
