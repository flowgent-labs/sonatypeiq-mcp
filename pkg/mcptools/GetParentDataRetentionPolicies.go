...
func GetParentDataRetentionPoliciesHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/api/v2/dataRetentionPolicies/organizations/{organizationId}/parent", args, []string{"organizationId"}, contentType, "GetParentDataRetentionPolicies")
}
