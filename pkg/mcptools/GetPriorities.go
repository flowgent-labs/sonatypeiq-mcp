...
func GetPrioritiesHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/api/v2/developer/priorities/{applicationId}/{scanId}", args, []string{"applicationId", "scanId"}, contentType, "GetPriorities")
}
