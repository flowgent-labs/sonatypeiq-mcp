...
func GetAppliedLicenseOverridesForLegalReviewerHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/api/v2/licenseOverrides/{ownerType}/{ownerId}/legalReviewer", args, []string{"ownerId", "ownerType"}, contentType, "GetAppliedLicenseOverridesForLegalReviewer")
}
