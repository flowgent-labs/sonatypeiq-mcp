...
func GetAttributionReportTemplateByIdHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/api/v2/licenseLegalMetadata/report-template/{id}", args, []string{"id"}, contentType, "GetAttributionReportTemplateById")
}
