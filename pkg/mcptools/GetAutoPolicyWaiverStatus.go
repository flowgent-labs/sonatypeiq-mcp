...
func GetAutoPolicyWaiverStatusHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/api/v2/autoPolicyWaivers/{ownerType}/{ownerId}/status", args, []string{"ownerId", "ownerType"}, contentType, "GetAutoPolicyWaiverStatus")
}
