...
func GetBulkRoleMembershipsNonGlobalHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/api/v2/roleMemberships/{ownerType}/{internalOwnerId}/roles", args, []string{"internalOwnerId", "ownerType"}, contentType, "GetBulkRoleMembershipsNonGlobal")
}
