...
func GetCascadeStatusHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/api/v2/firewall/repositories/cascade-reevaluate/status/{requestId}", args, []string{"requestId"}, contentType, "GetCascadeStatus")
}
