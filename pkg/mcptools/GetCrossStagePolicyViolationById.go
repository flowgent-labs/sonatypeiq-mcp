...
func GetCrossStagePolicyViolationByIdHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/api/v2/policyViolations/crossStage/{violationId}", args, []string{"violationId"}, contentType, "GetCrossStagePolicyViolationById")
}
