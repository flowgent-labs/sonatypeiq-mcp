...
func GetApplicationEvaluationStatusHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/api/v2/evaluation/applications/{applicationId}/status/{statusId}", args, []string{"applicationId", "statusId"}, contentType, "GetApplicationEvaluationStatus")
}
