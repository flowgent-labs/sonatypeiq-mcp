...
func GetTransitivePolicyViolationsByAppScanComponentHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/api/v2/policyViolations/transitive/{ownerType}/{ownerId}/{scanId}", args, []string{"ownerId", "ownerType", "scanId"}, contentType, "GetTransitivePolicyViolationsByAppScanComponent")
}
