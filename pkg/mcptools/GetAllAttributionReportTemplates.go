...
func GetAllAttributionReportTemplatesHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/api/v2/licenseLegalMetadata/report-template", args, []string{}, contentType, "GetAllAttributionReportTemplates")
}
