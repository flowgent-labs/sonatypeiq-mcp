...
func GetComponentEvaluationHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/api/v2/evaluation/applications/{applicationId}/results/{resultId}", args, []string{"applicationId", "resultId"}, contentType, "GetComponentEvaluation")
}
