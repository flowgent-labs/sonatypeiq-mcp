...
EOEX
  ...
  ./mcpclient.sh call AddArtifactoryConnection '{"internalOwnerId": "internalOwnerId_value", "ownerType": "application", "body": {"artifactoryConnectionId": "artifactoryConnectionId_value", "baseUrl": "baseUrl_value", "isAnonymous": false, "ownerId": "ownerId_value", "ownerType": "application", "password": "password_value", "username": "username_value"}}'
EOEX
  cat <<'EOEX'
...
EOEX
  ...
  ./mcpclient.sh call AddAutoPolicyWaiver '{"ownerId": "ownerId_value", "ownerType": "application", "body": {"autoPolicyWaiverId": "autoPolicyWaiverId_value", "createTime": "2025-01-01", "creatorId": "creatorId_value", "creatorName": "creatorName_value", "ownerId": "ownerId_value", "ownerName": "ownerName_value", "ownerType": "ownerType_value", "pathForward": false, "publicId": "publicId_value", "reachability": false, "scopesOperatorAny": false, "threatLevel": 0}}'
EOEX
  cat <<'EOEX'
...
EOEX
  ...
  ./mcpclient.sh call AddSourceControl '{"internalOwnerId": "internalOwnerId_value", "ownerType": "application", "body": {"authenticationType": "authenticationType_value", "baseBranch": "baseBranch_value", "closePrAfterDays": 0, "closePrAfterDaysOpenEnabled": false, "closePrOnFailedChecksEnabled": false, "commitStatusEnabled": false, "enablePullRequests": false, "enableStatusChecks": false, "githubAppId": "githubAppId_value", "id": "id_value", "innerSourceAutomatedUpdatesEnabled": false, "manualPullRequestsEnabled": false, "nonGoldenPullRequestsEnabled": false, "ownerId": "ownerId_value", "provider": "provider_value", "pullRequestCommentingEnabled": false, "remediationPullRequestsEnabled": false, "repositoryUrl": "repositoryUrl_value", "sourceControlEvaluationsEnabled": false, "sourceControlScanTarget": "sourceControlScanTarget_value", "sshEnabled": false, "statusChecksEnabled": false, "token": "token_value", "username": "username_value"}}'
EOEX
  cat <<'EOEX'
  # AddTag (POST)
